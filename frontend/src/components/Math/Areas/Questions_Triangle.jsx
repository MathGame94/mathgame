...
const QUESTIONS = [
  {
    ...
    steps: [
      {
        instruction: "اكتب قانون مساحة المثلث",
        placeholder: "مثال: م = (ق × ا) ÷ 2",
        accepted: ["م=(ق×ا)÷2", "م = (ق × ا) ÷ 2", "م=(قxا)÷2", "م = (ق x ا) ÷ 2"],
        hint: "مساحة المثلث تساوي القاعدة مضروبة في الارتفاع، والناتج مقسوم على 2",
        display: "م = (ق × ا) ÷ 2",
      },
      {
        instruction: "عوّض قيمتي القاعدة والارتفاع في القانون",
        placeholder: "مثال: م = (8 × 5) ÷ 2",
        accepted: ["م=(8×5)÷2", "م = (8 × 5) ÷ 2", "م=(8x5)÷2", "م = (8 x 5) ÷ 2"],
        hint: "القاعدة 8 سم والارتفاع 5 سم، نعوضهما في القانون",
        display: "م = (8 × 5) ÷ 2",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 20 سم²",
        accepted: ["م=20سم²", "م = 20 سم²", "م=20سم2", "20سم²", "20"],
        hint: "8 × 5 = 40، ثم 40 ÷ 2 = 20، فتكون المساحة 20 سم²",
        display: "م = 20 سم²",
      },
    ],
  },
  {
    id: 2,
    equation: "مثلث قاعدته 12 سم وارتفاعه 6 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المثلث",
        placeholder: "مثال: م = (ق × ا) ÷ 2",
      ...
      {
        instruction: "عوّض قيمتي القاعدة والارتفاع في القانون",
        placeholder: "مثال: م = (12 × 6) ÷ 2",
        accepted: ["م=(12×6)÷2", "م = (12 × 6) ÷ 2", "م=(12x6)÷2", "م = (12 x 6) ÷ 2"],
        hint: "القاعدة 12 سم والارتفاع 6 سم، نعوضهما في القانون",
        display: "م = (12 × 6) ÷ 2",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 36 سم²",
        accepted: ["م=36سم²", "م = 36 سم²", "م=36سم2", "36سم²", "36"],
        hint: "12 × 6 = 72، ثم 72 ÷ 2 = 36، فتكون المساحة 36 سم²",
        display: "م = 36 سم²",
      },
    ],
  },
  {
    id: 3,
    equation: "مثلث قاعدته 10 سم وارتفاعه 9 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المثلث",
        placeholder: "مثال: م = (ق × ا) ÷ 2",
      ...
      {
        instruction: "عوّض قيمتي القاعدة والارتفاع في القانون",
        placeholder: "مثال: م = (10 × 9) ÷ 2",
        accepted: ["م=(10×9)÷2", "م = (10 × 9) ÷ 2", "م=(10x9)÷2", "م = (10 x 9) ÷ 2"],
        hint: "القاعدة 10 سم والارتفاع 9 سم، نعوضهما في القانون",
        display: "م = (10 × 9) ÷ 2",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 45 سم²",
        accepted: ["م=45سم²", "م = 45 سم²", "م=45سم2", "45سم²", "45"],
        hint: "10 × 9 = 90، ثم 90 ÷ 2 = 45، فتكون المساحة 45 سم²",
        display: "م = 45 سم²",
      },
    ],
  },
  {
    id: 4,
    equation: "مثلث قاعدته 14 سم وارتفاعه 4 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المثلث",
        placeholder: "مثال: م = (ق × ا) ÷ 2",
      ...
      {
        instruction: "عوّض قيمتي القاعدة والارتفاع في القانون",
        placeholder: "مثال: م = (14 × 4) ÷ 2",
        accepted: ["م=(14×4)÷2", "م = (14 × 4) ÷ 2", "م=(14x4)÷2", "م = (14 x 4) ÷ 2"],
        hint: "القاعدة 14 سم والارتفاع 4 سم، نعوضهما في القانون",
        display: "م = (14 × 4) ÷ 2",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        ...
        hint: "14 × 4 = 56، ثم 56 ÷ 2 = 28، فتكون المساحة 28 سم²",
        display: "م = 28 سم²",
      },
    ],
  },
  {
    id: 5,
    equation: "مثلث قاعدته 9 سم وارتفاعه 7 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المثلث",
        placeholder: "مثال: م = (ق × ا) ÷ 2",
      ...
      {
        instruction: "عوّض قيمتي القاعدة والارتفاع في القانون",
        placeholder: "مثال: م = (9 × 7) ÷ 2",
        accepted: ["م=(9×7)÷2", "م = (9 × 7) ÷ 2", "م=(9x7)÷2", "م = (9 x 7) ÷ 2"],
        hint: "القاعدة 9 سم والارتفاع 7 سم، نعوضهما في القانون",
        display: "م = (9 × 7) ÷ 2",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة (الناتج قد يكون عدداً عشرياً)",
        placeholder: "مثال: م = 31.5 سم²",
        accepted: ["م=31.5سم²", "م = 31.5 سم²", "م=31.5سم2", "31.5سم²", "31.5"],
        hint: "9 × 7 = 63، ثم 63 ÷ 2 = 31.5، فتكون المساحة 31.5 سم²",
        display: "م = 31.5 سم²",
      },
    ],
  },
...
export default function Questions_Triangle({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - مساحة المثلث*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · مساحة المثلث</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين مساحة المثلث · النتيجة</div>
