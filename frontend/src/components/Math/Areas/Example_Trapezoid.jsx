...
// ── Example 1: شبه منحرف قاعدتاه 10 سم و6 سم وارتفاعه 4 سم ──
const EXAMPLE_BASIC = {
  equation: "شبه منحرف قاعدتاه 10 سم و6 سم وارتفاعه 4 سم",
  label: "مثال أساسي",
  steps: [
    {
      text: "لدينا شبه منحرف، وقانون مساحته هو جمع القاعدتين ثم ضرب الناتج في الارتفاع وقسمة الكل على 2. القاعدة الكبرى 10 سم والصغرى 6 سم والارتفاع 4 سم.",
      display: "م = ((ق١ + ق٢) × ا) ÷ 2",
      audio: "/audio/trapezoid-basic-step1.mp3",
    },
    {
      text: "نبدأ بجمع القاعدتين معاً.",
      display: "ق١ + ق٢ = 10 + 6 = 16",
      audio: "/audio/trapezoid-basic-step2.mp3",
    },
    {
      text: "نضرب مجموع القاعدتين في الارتفاع.",
      display: "16 × 4 = 64",
      audio: "/audio/trapezoid-basic-step3.mp3",
    },
    {
      text: "نقسم الناتج على 2 لنحصل على المساحة النهائية، مع إضافة الوحدة المربعة.",
      display: "الحل النهائي: م = 32 سم²",
      audio: "/audio/trapezoid-basic-step4.mp3",
      isFinal: true,
    },
  ],
};

// ── Example 2: شبه منحرف قاعدتاه 14 سم و8 سم وارتفاعه 5 سم ──
const EXAMPLE_LARGER = {
  equation: "شبه منحرف قاعدتاه 14 سم و8 سم وارتفاعه 5 سم",
  label: "مثال بأرقام أكبر",
  steps: [
    {
      text: "نطبّق نفس القانون دائماً: نجمع القاعدتين، نضرب المجموع في الارتفاع، ثم نقسم الناتج على 2.",
      display: "م = ((ق١ + ق٢) × ا) ÷ 2",
      audio: "/audio/trapezoid-larger-step1.mp3",
    },
    {
      text: "نجمع القاعدتين: القاعدة الكبرى 14 سم والصغرى 8 سم.",
      display: "ق١ + ق٢ = 14 + 8 = 22",
      audio: "/audio/trapezoid-larger-step2.mp3",
    },
    {
      text: "نضرب مجموع القاعدتين في الارتفاع، وهو 5 سم.",
      display: "22 × 5 = 110",
      audio: "/audio/trapezoid-larger-step3.mp3",
    },
    {
      text: "نقسم الناتج على 2 لنحصل على المساحة النهائية، مع إضافة الوحدة المربعة.",
      display: "الحل النهائي: م = 55 سم²",
      audio: "/audio/trapezoid-larger-step4.mp3",
      isFinal: true,
    },
  ],
};
...
export default function Example_Trapezoid({ onNext }) {
  ...
  const sendToWhatsApp = () => {
    ...
    const msg =
      `📚 *سؤال من الطالب: ${name}*\n` +
      `📌 *المثال:* حساب مساحة ${example.equation} (شبه المنحرف)\n\n` +
      `❓ *السؤال:*\n${question.trim()}`;
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {/* ── Header ── */}
        <div style={styles.eyebrow}>مثال محلول · مساحة شبه المنحرف</div>
      ...
      <button onClick={() => { navigate("/questionsTrapezoid"); }} style={styles.exerciseBtn}>
        ابدأ التمرين ←
      </button>
      <style>{`
        @keyframes pulse {
