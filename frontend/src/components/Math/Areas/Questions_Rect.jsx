...
// ── 5 Questions: مساحة المربع والمستطيل ──
const QUESTIONS = [
  {
    id: 1,
    equation: "مستطيل طوله 7 سم وعرضه 5 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المستطيل",
        placeholder: "مثال: م = ط × ع",
        accepted: ["م=ط×ع", "م = ط × ع", "م=طxع", "م = ط x ع"],
        hint: "مساحة المستطيل تساوي الطول مضروباً في العرض",
        display: "م = ط × ع",
      },
      {
        instruction: "عوّض قيمتي الطول والعرض في القانون",
        placeholder: "مثال: م = 7 × 5",
        accepted: ["م=7×5", "م = 7 × 5", "م=7x5", "م = 7 x 5"],
        hint: "الطول 7 سم والعرض 5 سم، نعوضهما في القانون",
        display: "م = 7 × 5",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 35 سم²",
        accepted: ["م=35سم²", "م = 35 سم²", "م=35سم2", "35سم²", "35"],
        hint: "7 × 5 = 35، فتكون المساحة 35 سم²",
        display: "م = 35 سم²",
      },
    ],
  },
  {
    id: 2,
    equation: "مربع طول ضلعه 6 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المربع",
        placeholder: "مثال: م = ض²",
        accepted: ["م=ض²", "م = ض²", "م=ضxض", "م = ض × ض"],
        hint: "مساحة المربع تساوي طول الضلع مضروباً في نفسه",
        display: "م = ض²",
      },
      {
        instruction: "عوّض طول الضلع في القانون",
        placeholder: "مثال: م = 6 × 6",
        accepted: ["م=6×6", "م = 6 × 6", "م=6x6", "م = 6 x 6"],
        hint: "طول الضلع 6 سم، نضربه في نفسه",
        display: "م = 6 × 6",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        ...
        hint: "6 × 6 = 36، فتكون المساحة 36 سم²",
        display: "م = 36 سم²",
      },
    ],
  },
  {
    id: 3,
    equation: "مستطيل طوله 10 سم وعرضه 3 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المستطيل",
        placeholder: "مثال: م = ط × ع",
      ...
      {
        instruction: "عوّض قيمتي الطول والعرض في القانون",
        placeholder: "مثال: م = 10 × 3",
        accepted: ["م=10×3", "م = 10 × 3", "م=10x3", "م = 10 x 3"],
        hint: "الطول 10 سم والعرض 3 سم، نعوضهما في القانون",
        display: "م = 10 × 3",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 30 سم²",
        accepted: ["م=30سم²", "م = 30 سم²", "م=30سم2", "30سم²", "30"],
        hint: "10 × 3 = 30، فتكون المساحة 30 سم²",
        display: "م = 30 سم²",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        instruction: "عوّض طول الضلع في القانون",
        placeholder: "مثال: م = 12 × 12",
        accepted: ["م=12×12", "م = 12 × 12", "م=12x12", "م = 12 x 12"],
        hint: "طول الضلع 12 سم، نضربه في نفسه",
        display: "م = 12 × 12",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 144 سم²",
        accepted: ["م=144سم²", "م = 144 سم²", "م=144سم2", "144سم²", "144"],
        hint: "12 × 12 = 144، فتكون المساحة 144 سم²",
        display: "م = 144 سم²",
      },
    ],
  },
  {
    id: 5,
    equation: "مستطيل طوله 9 سم وعرضه 8 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة المستطيل",
        placeholder: "مثال: م = ط × ع",
      ...
      {
        instruction: "عوّض قيمتي الطول والعرض في القانون",
        placeholder: "مثال: م = 9 × 8",
        accepted: ["م=9×8", "م = 9 × 8", "م=9x8", "م = 9 x 8"],
        hint: "الطول 9 سم والعرض 8 سم، نعوضهما في القانون",
        display: "م = 9 × 8",
      },
      {
        instruction: "احسب المساحة النهائية مع كتابة الوحدة المربعة",
        placeholder: "مثال: م = 72 سم²",
        accepted: ["م=72سم²", "م = 72 سم²", "م=72سم2", "72سم²", "72"],
        hint: "9 × 8 = 72، فتكون المساحة 72 سم²",
        display: "م = 72 سم²",
      },
    ],
  },
...
export default function Questions_Rect({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - مساحة المربع والمستطيل*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · مساحة المربع والمستطيل</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين مساحة المربع والمستطيل · النتيجة</div>
