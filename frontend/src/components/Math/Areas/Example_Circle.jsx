...
// ── Example 1: دائرة نصف قطرها 7 سم ──
const EXAMPLE_BASIC = {
  equation: "دائرة نصف قطرها 7 سم",
  label: "مثال أساسي",
  steps: [
    {
      text: "لدينا دائرة، وقانون مساحتها هو ضرب الثابت π (≈ 3.14) في مربع نصف القطر. نصف القطر هنا 7 سم.",
      display: "م = π × نق²",
      audio: "/audio/circle-basic-step1.mp3",
    },
    {
      text: "نحسب مربع نصف القطر أولاً، أي نضرب 7 في نفسها.",
      display: "نق² = 7 × 7 = 49",
      audio: "/audio/circle-basic-step2.mp3",
    },
    {
      text: "نضرب الناتج في قيمة π التقريبية 3.14.",
      display: "م = 3.14 × 49",
      audio: "/audio/circle-basic-step3.mp3",
    },
    {
      text: "نحسب حاصل الضرب لنحصل على المساحة النهائية، مع إضافة الوحدة المربعة.",
      display: "الحل النهائي: م = 153.86 سم²",
      audio: "/audio/circle-basic-step4.mp3",
      isFinal: true,
    },
  ],
};

// ── Example 2: دائرة قطرها 12 سم ──
const EXAMPLE_DIAMETER = {
  equation: "دائرة قطرها 12 سم",
  label: "مثال بالقطر",
  steps: [
    {
      text: "هذه المرة أُعطينا القطر وليس نصف القطر. يجب أولاً قسمة القطر على 2 لإيجاد نصف القطر قبل تطبيق القانون.",
      display: "نق = القطر ÷ 2 = 12 ÷ 2",
      audio: "/audio/circle-diameter-step1.mp3",
    },
    {
      text: "نحسب نصف القطر، فيكون 6 سم.",
      display: "نق = 6",
      audio: "/audio/circle-diameter-step2.mp3",
    },
    {
      text: "الآن نطبّق قانون المساحة: π مضروباً في مربع نصف القطر.",
      display: "م = π × 6² = 3.14 × 36",
      audio: "/audio/circle-diameter-step3.mp3",
    },
    {
      text: "نحسب حاصل الضرب لنحصل على المساحة النهائية، مع إضافة الوحدة المربعة.",
      display: "الحل النهائي: م = 113.04 سم²",
      audio: "/audio/circle-diameter-step4.mp3",
      isFinal: true,
    },
  ],
};

const EXAMPLES = [EXAMPLE_BASIC, EXAMPLE_DIAMETER];

export default function Example_Circle({ onNext }) {
  ...
  const sendToWhatsApp = () => {
    ...
    const msg =
      `📚 *سؤال من الطالب: ${name}*\n` +
      `📌 *المثال:* حساب مساحة ${example.equation} (الدائرة)\n\n` +
      `❓ *السؤال:*\n${question.trim()}`;
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {/* ── Header ── */}
        <div style={styles.eyebrow}>مثال محلول · مساحة الدائرة</div>
      ...
      <button onClick={() => { navigate("/questionsCircle"); }} style={styles.exerciseBtn}>
        ابدأ التمرين ←
      </button>
      <style>{`
        @keyframes pulse {
