...
// ── 5 Questions: مساحة الدائرة (π ≈ 3.14) ──
const QUESTIONS = [
  {
    id: 1,
    equation: "دائرة نصف قطرها 7 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة الدائرة",
        placeholder: "مثال: م = π × نق²",
        accepted: ["م=π×نق²", "م = π × نق²", "م=πxنق²", "م = π x نق²", "م=π×نق2"],
        hint: "مساحة الدائرة تساوي π مضروباً في مربع نصف القطر",
        display: "م = π × نق²",
      },
      {
        instruction: "احسب مربع نصف القطر",
        placeholder: "مثال: نق² = 49",
        accepted: ["نق²=49", "نق² = 49", "نق2=49", "49"],
        hint: "نصف القطر 7 سم، نضربه في نفسه: 7 × 7 = 49",
        display: "نق² = 49",
      },
      {
        instruction: "اضرب الناتج في π (استخدم 3.14) واكتب المساحة النهائية مع الوحدة المربعة",
        placeholder: "مثال: م = 153.86 سم²",
        accepted: ["م=153.86سم²", "م = 153.86 سم²", "م=153.86سم2", "153.86سم²", "153.86"],
        hint: "3.14 × 49 = 153.86، فتكون المساحة 153.86 سم²",
        display: "م = 153.86 سم²",
      },
    ],
  },
  {
    id: 2,
    equation: "دائرة نصف قطرها 10 سم",
    steps: [
      {
        instruction: "اكتب قانون مساحة الدائرة",
        placeholder: "مثال: م = π × نق²",
      ...
      {
        instruction: "احسب مربع نصف القطر",
        placeholder: "مثال: نق² = 100",
        accepted: ["نق²=100", "نق² = 100", "نق2=100", "100"],
        hint: "نصف القطر 10 سم، نضربه في نفسه: 10 × 10 = 100",
        display: "نق² = 100",
      },
      {
        instruction: "اضرب الناتج في π (استخدم 3.14) واكتب المساحة النهائية مع الوحدة المربعة",
        placeholder: "مثال: م = 314 سم²",
        accepted: ["م=314سم²", "م = 314 سم²", "م=314سم2", "314سم²", "314"],
        hint: "3.14 × 100 = 314، فتكون المساحة 314 سم²",
        display: "م = 314 سم²",
      },
    ],
  },
  {
    id: 3,
    equation: "دائرة قطرها 8 سم",
    steps: [
      {
        instruction: "هذه المرة أُعطينا القطر — احسب نصف القطر أولاً",
        placeholder: "مثال: نق = 4",
        accepted: ["نق=4", "نق = 4", "4"],
        hint: "نصف القطر = القطر ÷ 2 = 8 ÷ 2 = 4",
        display: "نق = 4",
      },
      {
        instruction: "احسب مربع نصف القطر",
        placeholder: "مثال: نق² = 16",
        accepted: ["نق²=16", "نق² = 16", "نق2=16", "16"],
        hint: "نصف القطر 4 سم، نضربه في نفسه: 4 × 4 = 16",
        display: "نق² = 16",
      },
      {
        instruction: "اضرب الناتج في π (استخدم 3.14) واكتب المساحة النهائية مع الوحدة المربعة",
        placeholder: "مثال: م = 50.24 سم²",
        accepted: ["م=50.24سم²", "م = 50.24 سم²", "م=50.24سم2", "50.24سم²", "50.24"],
        hint: "3.14 × 16 = 50.24، فتكون المساحة 50.24 سم²",
        display: "م = 50.24 سم²",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        instruction: "احسب مربع نصف القطر",
        placeholder: "مثال: نق² = 25",
        accepted: ["نق²=25", "نق² = 25", "نق2=25", "25"],
        hint: "نصف القطر 5 سم، نضربه في نفسه: 5 × 5 = 25",
        display: "نق² = 25",
      },
      {
        instruction: "اضرب الناتج في π (استخدم 3.14) واكتب المساحة النهائية مع الوحدة المربعة",
        placeholder: "مثال: م = 78.5 سم²",
        accepted: ["م=78.5سم²", "م = 78.5 سم²", "م=78.5سم2", "78.5سم²", "78.5"],
        hint: "3.14 × 25 = 78.5، فتكون المساحة 78.5 سم²",
        display: "م = 78.5 سم²",
      },
    ],
  },
  {
    id: 5,
    equation: "دائرة قطرها 20 سم",
    steps: [
      {
        instruction: "هذه المرة أُعطينا القطر — احسب نصف القطر أولاً",
        placeholder: "مثال: نق = 10",
        accepted: ["نق=10", "نق = 10", "10"],
        hint: "نصف القطر = القطر ÷ 2 = 20 ÷ 2 = 10",
        display: "نق = 10",
      },
      {
        instruction: "احسب مربع نصف القطر",
...
export default function Questions_Circle({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - مساحة الدائرة*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · مساحة الدائرة</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين مساحة الدائرة · النتيجة</div>
