...
// ── 5 Questions: ax + b = c  أو  x/a + b = c (النوع الخامس: أكثر من رقم مع x) ──
const QUESTIONS = [
  {
    id: 1,
    equation: "2x + 5 = 11",
    steps: [
      {
        instruction: "حدد الرقم المُضاف أو المطروح مع ax (الأبعد عن x)، واكتب العملية المعكوسة للتخلص منه",
        placeholder: "مثال: طرح",
        accepted: ["طرح", "الطرح"],
        hint: "الرقم 5 مُضاف مع 2x، فالعملية المعكوسة هي الطرح — نبدأ دائماً بالرقم الأبعد عن x",
        display: "الخطوة الأولى: طرح 5 من الطرفين",
      },
      {
        instruction: "انقل الرقم 5 للطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: 2x = 11 − 5",
        accepted: ["2x=11-5", "2x = 11 − 5", "2x=11−5", "2x = 11 - 5"],
        hint: "5 مُضاف فينعكس للطرف الآخر طرحاً → 2x = 11 − 5",
        display: "2x = 11 − 5",
      },
      {
        instruction: "احسب الطرف الأيمن",
        placeholder: "مثال: 2x = 6",
        accepted: ["2x=6", "2x = 6"],
        hint: "11 − 5 = 6 → 2x = 6",
        display: "2x = 6",
      },
      {
        instruction: "الآن تبقى رقم مضروب في x فقط — اكتب العملية المعكوسة للتخلص من 2",
        placeholder: "مثال: قسمة",
        accepted: ["قسمة", "القسمة"],
        hint: "الرقم 2 مضروب في x، فالعملية المعكوسة هي القسمة على 2",
        display: "الخطوة الثانية: قسمة الطرفين على 2",
      },
      {
        instruction: "اقسم الطرفين على 2 واكتب القيمة النهائية لـ x",
  ...
  },
  {
    ...
    steps: [
      {
        instruction: "حدد الرقم المُضاف أو المطروح مع ax (الأبعد عن x)، واكتب العملية المعكوسة للتخلص منه",
        placeholder: "مثال: جمع",
        accepted: ["جمع", "الجمع"],
        hint: "الرقم 4 مطروح من 3x، فالعملية المعكوسة هي الجمع — نبدأ دائماً بالرقم الأبعد عن x",
        display: "الخطوة الأولى: جمع 4 للطرفين",
      },
      {
        instruction: "انقل الرقم 4 للطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: 3x = 8 + 4",
        accepted: ["3x=8+4", "3x = 8 + 4"],
        hint: "4 مطروح فينعكس للطرف الآخر جمعاً → 3x = 8 + 4",
        display: "3x = 8 + 4",
      },
      {
        instruction: "احسب الطرف الأيمن",
        placeholder: "مثال: 3x = 12",
        accepted: ["3x=12", "3x = 12"],
        hint: "8 + 4 = 12 → 3x = 12",
        display: "3x = 12",
      },
      {
        instruction: "الآن تبقى رقم مضروب في x فقط — اكتب العملية المعكوسة للتخلص من 3",
        placeholder: "مثال: قسمة",
        accepted: ["قسمة", "القسمة"],
        hint: "الرقم 3 مضروب في x، فالعملية المعكوسة هي القسمة على 3",
        display: "الخطوة الثانية: قسمة الطرفين على 3",
      },
      {
        instruction: "اقسم الطرفين على 3 واكتب القيمة النهائية لـ x",
  ...
  },
  {
    ...
    steps: [
      {
        instruction: "حدد الرقم المُضاف أو المطروح مع x/2 (الأبعد عن x)، واكتب العملية المعكوسة للتخلص منه",
        placeholder: "مثال: طرح",
        accepted: ["طرح", "الطرح"],
        hint: "الرقم 3 مُضاف مع x/2، فالعملية المعكوسة هي الطرح — نبدأ دائماً بالرقم الأبعد عن x",
        display: "الخطوة الأولى: طرح 3 من الطرفين",
      },
      {
        instruction: "انقل الرقم 3 للطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x/2 = 7 − 3",
        accepted: ["x/2=7-3", "x/2 = 7 − 3", "x/2=7−3", "x/2 = 7 - 3"],
        hint: "3 مُضاف فينعكس للطرف الآخر طرحاً → x/2 = 7 − 3",
        display: "x/2 = 7 − 3",
      },
      {
        instruction: "احسب الطرف الأيمن",
        placeholder: "مثال: x/2 = 4",
        accepted: ["x/2=4", "x/2 = 4"],
        hint: "7 − 3 = 4 → x/2 = 4",
        display: "x/2 = 4",
      },
      {
        instruction: "الآن تبقى x مقسومة على 2 فقط — اكتب العملية المعكوسة للتخلص من القسمة على 2",
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "x مقسومة على 2، فالعملية المعكوسة هي الضرب في 2",
        display: "الخطوة الثانية: ضرب الطرفين في 2",
      },
      {
        instruction: "اضرب الطرفين في 2 واكتب القيمة النهائية لـ x",
        placeholder: "مثال: x = 8",
        accepted: ["x=8", "x = 8", "8"],
        hint: "4 × 2 = 8",
        display: "x = 8",
      },
    ...
    steps: [
      {
        ...
        placeholder: "مثال: طرح",
        accepted: ["طرح", "الطرح"],
        hint: "الرقم 7 مُضاف مع 4x، فالعملية المعكوسة هي الطرح",
        display: "الخطوة الأولى: طرح 7 من الطرفين",
      },
      {
        instruction: "انقل الرقم 7 للطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: 4x = −1 − 7",
        accepted: ["4x=-1-7", "4x = −1 − 7", "4x=−1−7", "4x = -1 - 7"],
        hint: "7 مُضاف فينعكس للطرف الآخر طرحاً → 4x = −1 − 7",
        display: "4x = −1 − 7",
      },
      {
        instruction: "احسب الطرف الأيمن (انتبه للإشارات)",
        placeholder: "مثال: 4x = −8",
        accepted: ["4x=-8", "4x = −8", "4x=−8", "4x = -8"],
        hint: "−1 − 7 = −8 → 4x = −8",
        display: "4x = −8",
      },
      {
        instruction: "الآن تبقى رقم مضروب في x فقط — اكتب العملية المعكوسة للتخلص من 4",
        placeholder: "مثال: قسمة",
        accepted: ["قسمة", "القسمة"],
        hint: "الرقم 4 مضروب في x، فالعملية المعكوسة هي القسمة على 4",
        display: "الخطوة الثانية: قسمة الطرفين على 4",
      },
      {
        instruction: "اقسم الطرفين على 4 واكتب القيمة النهائية لـ x (انتبه للإشارة)",
        placeholder: "مثال: x = −2",
        accepted: ["x=-2", "x = −2", "x=−2", "x = -2", "-2", "−2"],
        hint: "−8 ÷ 4 = −2 (سالب ÷ موجب = سالب)",
        display: "x = −2",
      },
    ],
  },
  {
    ...
    steps: [
      {
        instruction: "حدد الرقم المُضاف أو المطروح مع x/3 (الأبعد عن x)، واكتب العملية المعكوسة للتخلص منه",
        placeholder: "مثال: جمع",
        accepted: ["جمع", "الجمع"],
        hint: "الرقم 2 مطروح من x/3، فالعملية المعكوسة هي الجمع",
        display: "الخطوة الأولى: جمع 2 للطرفين",
      },
      {
        instruction: "انقل الرقم 2 للطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x/3 = 4 + 2",
        accepted: ["x/3=4+2", "x/3 = 4 + 2"],
        hint: "2 مطروح فينعكس للطرف الآخر جمعاً → x/3 = 4 + 2",
        display: "x/3 = 4 + 2",
      },
      {
        instruction: "احسب الطرف الأيمن",
        placeholder: "مثال: x/3 = 6",
        accepted: ["x/3=6", "x/3 = 6"],
        hint: "4 + 2 = 6 → x/3 = 6",
        display: "x/3 = 6",
      },
      {
        instruction: "الآن تبقى x مقسومة على 3 فقط — اكتب العملية المعكوسة للتخلص من القسمة على 3",
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "x مقسومة على 3، فالعملية المعكوسة هي الضرب في 3",
        display: "الخطوة الثانية: ضرب الطرفين في 3",
      },
      {
        instruction: "اضرب الطرفين في 3 واكتب القيمة النهائية لـ x",
        placeholder: "مثال: x = 18",
        accepted: ["x=18", "x = 18", "18"],
        hint: "6 × 3 = 18",
        display: "x = 18",
      },
    ],
...
export default function Questions_Multi({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - أكثر من رقم مع x معاً*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · أكثر من رقم مع x معاً</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين أكثر من رقم مع x · النتيجة</div>
