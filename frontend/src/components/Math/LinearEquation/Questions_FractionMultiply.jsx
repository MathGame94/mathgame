...
// ── 5 Questions: (a/b) × x = c  (x مضروب بكسر) ──
const QUESTIONS = [
  {
    id: 1,
    equation: "(1/2) × x = 6",
    steps: [
      {
        instruction: "حدد الكسر المضروب في x، واكتب العملية المعكوسة للتخلص منه",
        placeholder: "مثال: ضرب في مقلوب الكسر",
        accepted: ["ضرب في مقلوب الكسر", "ضرب بمقلوب الكسر", "مقلوب الكسر"],
        hint: "بما أن x مضروب في الكسر (1/2)، فالعملية المعكوسة هي الضرب في مقلوبه وهو (2/1) = 2",
        display: "العملية المعكوسة: ضرب في مقلوب الكسر",
      },
      {
        instruction: "اكتب مقلوب الكسر (1/2)",
        placeholder: "مثال: 2/1",
        accepted: ["2/1", "2", "2÷1"],
        hint: "مقلوب الكسر (1/2) هو (2/1) أي 2",
        display: "مقلوب (1/2) = 2/1 = 2",
      },
      {
        instruction: "اضرب طرفَي المعادلة في مقلوب الكسر، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 6 × 2",
        accepted: ["x=6×2", "x = 6 × 2", "x=6*2", "x = 6 * 2", "x=6x2", "x = 6x2"],
        hint: "نضرب الطرفين في 2 → x = 6 × 2",
        display: "x = 6 × 2",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
        placeholder: "مثال: x = 12",
        accepted: ["x=12", "x = 12", "12"],
        hint: "6 × 2 = 12",
        display: "x = 12",
      },
    ],
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب في مقلوب الكسر",
        accepted: ["ضرب في مقلوب الكسر", "ضرب بمقلوب الكسر", "مقلوب الكسر"],
        hint: "بما أن x مضروب في (3/4)، فالعملية المعكوسة هي الضرب في مقلوبه وهو (4/3)",
        display: "العملية المعكوسة: ضرب في مقلوب الكسر",
      },
      {
        instruction: "اكتب مقلوب الكسر (3/4)",
        placeholder: "مثال: 4/3",
        accepted: ["4/3"],
        hint: "مقلوب الكسر (3/4) هو (4/3) — نعكس البسط والمقام",
        display: "مقلوب (3/4) = 4/3",
      },
      {
        instruction: "اضرب طرفَي المعادلة في (4/3)، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 9 × 4/3",
        accepted: ["x=9×4/3", "x = 9 × 4/3", "x=9*4/3", "x = 9 * 4/3", "x=9×(4/3)", "x = 9 × (4/3)"],
        hint: "نضرب الطرفين في (4/3) → x = 9 × 4/3",
        display: "x = 9 × 4/3",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب في مقلوب الكسر",
        accepted: ["ضرب في مقلوب الكسر", "ضرب بمقلوب الكسر", "مقلوب الكسر"],
        hint: "بما أن x مضروب في (2/5)، فالعملية المعكوسة هي الضرب في مقلوبه وهو (5/2)",
        display: "العملية المعكوسة: ضرب في مقلوب الكسر",
      },
      {
        instruction: "اكتب مقلوب الكسر (2/5)",
        placeholder: "مثال: 5/2",
        accepted: ["5/2"],
        hint: "مقلوب الكسر (2/5) هو (5/2) — نعكس البسط والمقام",
        display: "مقلوب (2/5) = 5/2",
      },
      {
        instruction: "اضرب طرفَي المعادلة في (5/2)، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 8 × 5/2",
        accepted: ["x=8×5/2", "x = 8 × 5/2", "x=8*5/2", "x = 8 * 5/2", "x=8×(5/2)", "x = 8 × (5/2)"],
        hint: "نضرب الطرفين في (5/2) → x = 8 × 5/2",
        display: "x = 8 × 5/2",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
        placeholder: "مثال: x = 20",
        accepted: ["x=20", "x = 20", "20"],
        hint: "8 × 5 = 40، ثم 40 ÷ 2 = 20",
        display: "x = 20",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب في مقلوب الكسر",
        accepted: ["ضرب في مقلوب الكسر", "ضرب بمقلوب الكسر", "مقلوب الكسر"],
        hint: "بما أن x مضروب في (3/7)، فالعملية المعكوسة هي الضرب في مقلوبه وهو (7/3)",
        display: "العملية المعكوسة: ضرب في مقلوب الكسر",
      },
      {
        instruction: "اكتب مقلوب الكسر (3/7)",
        placeholder: "مثال: 7/3",
        accepted: ["7/3"],
        hint: "مقلوب الكسر (3/7) هو (7/3) — نعكس البسط والمقام",
        display: "مقلوب (3/7) = 7/3",
      },
      {
        instruction: "اضرب طرفَي المعادلة في (7/3)، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 6 × 7/3",
        accepted: ["x=6×7/3", "x = 6 × 7/3", "x=6*7/3", "x = 6 * 7/3", "x=6×(7/3)", "x = 6 × (7/3)"],
        hint: "نضرب الطرفين في (7/3) → x = 6 × 7/3",
        display: "x = 6 × 7/3",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
        placeholder: "مثال: x = 14",
        accepted: ["x=14", "x = 14", "14"],
        hint: "6 × 7 = 42، ثم 42 ÷ 3 = 14",
        display: "x = 14",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب في مقلوب الكسر",
        accepted: ["ضرب في مقلوب الكسر", "ضرب بمقلوب الكسر", "مقلوب الكسر"],
        hint: "بما أن x مضروب في (5/6)، فالعملية المعكوسة هي الضرب في مقلوبه وهو (6/5)",
        display: "العملية المعكوسة: ضرب في مقلوب الكسر",
      },
      {
        instruction: "اكتب مقلوب الكسر (5/6)",
        placeholder: "مثال: 6/5",
        accepted: ["6/5"],
        hint: "مقلوب الكسر (5/6) هو (6/5) — نعكس البسط والمقام",
        display: "مقلوب (5/6) = 6/5",
      },
      {
        instruction: "اضرب طرفَي المعادلة في (6/5)، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 10 × 6/5",
        accepted: ["x=10×6/5", "x = 10 × 6/5", "x=10*6/5", "x = 10 * 6/5", "x=10×(6/5)", "x = 10 × (6/5)"],
        hint: "نضرب الطرفين في (6/5) → x = 10 × 6/5",
        display: "x = 10 × 6/5",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
...
export default function Questions_FractionMultiply({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - x مضروب بكسر*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · x مضروب بكسر</div>
  ...
  if (done) {
    ...
    const grade =
      pct === 100 ? { label: "ممتاز! 🌟", color: "#5B8266", bg: "#EAF1EC" } :
      pct >= 60   ? { label: "جيد، واصل! 💪", color: "#3D6B8A", bg: "#E8F0F4" } :
                    { label: "راجع الدرس وحاول مجدداً 📖", color: "#D9695A", bg: "#FBEAE7" };
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين x مضروب بكسر · النتيجة</div>
          ...
          <div style={styles.breakdownCard}>
            ...
            {QUESTIONS.map((q, i) => (
              <div key={i} style={styles.breakdownRow}>
                ...
                <span style={{ fontFamily: "Georgia, serif", direction: "ltr", fontSize: 15, color: "#2A2730" }}>{q.equation}</span>
                <span style={{ fontSize: 12, color: scores[i] ? "#5B8266" : "#D9695A", fontWeight: 700 }}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.progressBar}>
          {QUESTIONS.map((_, i) => (
            <div key={i} style={{
              ...
              background: i < qIndex ? "#5B8266" : i === qIndex ? "#3D6B8A" : "#E5DDD0",
            }} />
          ))}
        </div>
        ...
        <div style={styles.activeCard}>
          ...
          <div style={styles.inputRow}>
            <input
              ...
              style={{
                ...styles.answerInput,
                borderColor: status === "correct" ? "#5B8266" : status === "wrong" ? "#D9695A" : "#E5DDD0",
                background: status === "correct" ? "#EAF1EC" : status === "wrong" ? "#FBEAE7" : "#F3ECE0",
              }}
          ...
          {status === "wrong" && <div style={styles.wrongMsg}>❌ إجابة خاطئة، حاول مرة أخرى</div>}
          {status === "wrong" && !showHint && (
            <button onClick={() => setShowHint(true)} style={styles.hintBtn}>💡 أظهر تلميح</button>
          )}
          {showHint && <div style={styles.hintBox}>💡 <strong>تلميح:</strong> {step.hint}</div>}
          {status === "correct" && (
        ...
        <div style={styles.scoreTracker}>
          {scores.map((s, i) => (
            <div key={i} style={{
              ...styles.scoreDot,
              background: s === null ? (i === qIndex ? "#E8F0F4" : "#E5DDD0") : s ? "#5B8266" : "#D9695A",
              border: i === qIndex ? "2px solid #3D6B8A" : "2px solid transparent",
            }}>
              {s === true ? "✓" : s === false ? "✗" : i + 1}
            </div>
          ))}
...
const styles = {
  ...
  equationText: { fontFamily: "Georgia, serif", direction: "ltr", fontSize: "clamp(20px, 5vw, 28px)", fontWeight: 700, color: "#FBF7F0" },
  ...
  checkBtn: { background: "#3D6B8A", color: "#fff", border: "none", borderRadius: 10, padding: "11px 18px", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'Segoe UI', Tahoma, sans-serif", flexShrink: 0 },
