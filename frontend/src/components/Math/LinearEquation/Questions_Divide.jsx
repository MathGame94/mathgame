...
const QUESTIONS = [
  {
    ...
    steps: [
      {
        instruction: "حدد الرقم الذي قُسم عليه x، واكتب العملية المعكوسة المناسبة للتخلص منه",
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "بما أن x مقسوم على 3، فالعملية المعكوسة هي الضرب (القسمة تصبح ضرباً عند عزل x)",
        display: "العملية المعكوسة: ضرب",
      },
      {
        instruction: "اضرب طرفَي المعادلة في 3، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 4 × 3",
        accepted: ["x=4×3", "x = 4 × 3", "x=4*3", "x = 4 * 3", "x=4x3", "x = 4x3"],
        hint: "نضرب الطرفين في 3 → x = 4 × 3",
        display: "x = 4 × 3",
      },
      {
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "بما أن x مقسوم على 5، فالعملية المعكوسة هي الضرب",
        display: "العملية المعكوسة: ضرب",
      },
      {
        instruction: "اضرب طرفَي المعادلة في 5، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 6 × 5",
        accepted: ["x=6×5", "x = 6 × 5", "x=6*5", "x = 6 * 5", "x=6x5", "x = 6x5"],
        hint: "نضرب الطرفين في 5 → x = 6 × 5",
        display: "x = 6 × 5",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
        placeholder: "مثال: x = 30",
        accepted: ["x=30", "x = 30", "30"],
        hint: "6 × 5 = 30",
        display: "x = 30",
      },
    ],
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "بما أن x مقسوم على 2، فالعملية المعكوسة هي الضرب",
        display: "العملية المعكوسة: ضرب",
      },
      {
        instruction: "اضرب طرفَي المعادلة في 2، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 9 × 2",
        accepted: ["x=9×2", "x = 9 × 2", "x=9*2", "x = 9 * 2", "x=9x2", "x = 9x2"],
        hint: "نضرب الطرفين في 2 → x = 9 × 2",
        display: "x = 9 × 2",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "بما أن x مقسوم على 4، فالعملية المعكوسة هي الضرب",
        display: "العملية المعكوسة: ضرب",
      },
      {
        instruction: "اضرب طرفَي المعادلة في 4، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 7 × 4",
        accepted: ["x=7×4", "x = 7 × 4", "x=7*4", "x = 7 * 4", "x=7x4", "x = 7x4"],
        hint: "نضرب الطرفين في 4 → x = 7 × 4",
        display: "x = 7 × 4",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
        placeholder: "مثال: x = 28",
        accepted: ["x=28", "x = 28", "28"],
        hint: "7 × 4 = 28",
        display: "x = 28",
      },
    ],
    ...
    steps: [
      {
        ...
        placeholder: "مثال: ضرب",
        accepted: ["ضرب", "الضرب"],
        hint: "بما أن x مقسوم على 6، فالعملية المعكوسة هي الضرب",
        display: "العملية المعكوسة: ضرب",
      },
      {
        instruction: "اضرب طرفَي المعادلة في 6، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 3 × 6",
        accepted: ["x=3×6", "x = 3 × 6", "x=3*6", "x = 3 * 6", "x=3x6", "x = 3x6"],
        hint: "نضرب الطرفين في 6 → x = 3 × 6",
        display: "x = 3 × 6",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
...
export default function Questions_Divide({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - x مقسوم على رقم*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · x مقسوم على رقم</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين x مقسوم على رقم · النتيجة</div>
...
const styles = {
  ...
  equationText: { fontFamily: "Georgia, serif", direction: "ltr", fontSize: "clamp(22px, 5.5vw, 30px)", fontWeight: 700, color: "#FBF7F0" },
