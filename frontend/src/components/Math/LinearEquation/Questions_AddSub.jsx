...
// ── 5 Questions: x + b = c  أو  x − b = c (رقم مُضاف أو مطروح مع x) ──
const QUESTIONS = [
  {
    id: 1,
    equation: "x + 5 = 12",
    steps: [
      {
        instruction: "حدد الرقم المُضاف مع x، واكتب العملية المعكوسة المناسبة للتخلص منه",
        placeholder: "مثال: طرح",
        accepted: ["طرح", "الطرح"],
        hint: "بما أن 5 مُضاف مع x، فالعملية المعكوسة هي الطرح (الجمع يصبح طرحاً عند النقل)",
        display: "العملية المعكوسة: طرح",
      },
      {
        instruction: "انقل الرقم 5 إلى الطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 12 − 5",
        accepted: ["x=12-5", "x = 12 − 5", "x=12−5", "x = 12 - 5"],
        hint: "ننقل 5 للطرف الآخر فتنعكس إشارته من + إلى − → x = 12 − 5",
        display: "x = 12 − 5",
      },
      {
  ...
  },
  {
    ...
    steps: [
      {
        instruction: "حدد الرقم المطروح من x، واكتب العملية المعكوسة المناسبة للتخلص منه",
        placeholder: "مثال: جمع",
        accepted: ["جمع", "الجمع"],
        hint: "بما أن 4 مطروح من x، فالعملية المعكوسة هي الجمع (الطرح يصبح جمعاً عند النقل)",
        display: "العملية المعكوسة: جمع",
      },
      {
        instruction: "انقل الرقم 4 إلى الطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 9 + 4",
        accepted: ["x=9+4", "x = 9 + 4"],
        hint: "ننقل 4 للطرف الآخر فتنعكس إشارته من − إلى + → x = 9 + 4",
        display: "x = 9 + 4",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
        placeholder: "مثال: x = 13",
        accepted: ["x=13", "x = 13", "13"],
        hint: "9 + 4 = 13",
        display: "x = 13",
      },
    ],
    ...
    steps: [
      {
        ...
        placeholder: "مثال: طرح",
        accepted: ["طرح", "الطرح"],
        hint: "بما أن 8 مُضاف مع x، فالعملية المعكوسة هي الطرح",
        display: "العملية المعكوسة: طرح",
      },
      {
        instruction: "انقل الرقم 8 إلى الطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 3 − 8",
        accepted: ["x=3-8", "x = 3 − 8", "x=3−8", "x = 3 - 8"],
        hint: "ننقل 8 للطرف الآخر فتنعكس إشارته من + إلى − → x = 3 − 8",
        display: "x = 3 − 8",
      },
      {
        instruction: "احسب القيمة النهائية لـ x (انتبه أن النتيجة سالبة هنا)",
        placeholder: "مثال: x = −5",
        accepted: ["x=-5", "x = −5", "x=−5", "x = -5", "-5", "−5"],
        hint: "3 − 8 = −5 (الطرف الأصغر مطروح منه الأكبر يعطي ناتجاً سالباً)",
        display: "x = −5",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        placeholder: "مثال: جمع",
        accepted: ["جمع", "الجمع"],
        hint: "بما أن 6 مطروح من x، فالعملية المعكوسة هي الجمع",
        display: "العملية المعكوسة: جمع",
      },
      {
        instruction: "انقل الرقم 6 إلى الطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = −2 + 6",
        accepted: ["x=-2+6", "x = −2 + 6", "x=−2+6", "x = -2 + 6"],
        hint: "ننقل 6 للطرف الآخر فتنعكس إشارته من − إلى + → x = −2 + 6",
        display: "x = −2 + 6",
      },
      {
        instruction: "احسب القيمة النهائية لـ x",
    ...
    steps: [
      {
        ...
        placeholder: "مثال: طرح",
        accepted: ["طرح", "الطرح"],
        hint: "بما أن 10 مُضاف مع x، فالعملية المعكوسة هي الطرح",
        display: "العملية المعكوسة: طرح",
      },
      {
        instruction: "انقل الرقم 10 إلى الطرف الآخر مع عكس إشارته، واكتب المعادلة الناتجة",
        placeholder: "مثال: x = 6 − 10",
        accepted: ["x=6-10", "x = 6 − 10", "x=6−10", "x = 6 - 10"],
        hint: "ننقل 10 للطرف الآخر فتنعكس إشارته من + إلى − → x = 6 − 10",
        display: "x = 6 − 10",
      },
      {
        instruction: "احسب القيمة النهائية لـ x (انتبه أن النتيجة سالبة هنا)",
        placeholder: "مثال: x = −4",
        accepted: ["x=-4", "x = −4", "x=−4", "x = -4", "-4", "−4"],
        hint: "6 − 10 = −4",
        display: "x = −4",
      },
    ],
...
export default function Questions_AddSub({ onFinish }) {
  ...
  const sendQuestionToWhatsApp = (index) => {
    ...
    const msg =
      `📐 *تقرير سؤال ${index + 1} - رقم مُضاف أو مطروح مع x*\n` +
      `👤 *الطالب:* ${name}\n` +
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · رقم مُضاف أو مطروح مع x</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين رقم مُضاف أو مطروح مع x · النتيجة</div>
