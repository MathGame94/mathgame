...
// ── Steps for solving: x² + 5x + 6 = 0 (a = 1) ──
const STEPS = [
  {
    text: "هذه معادلة تربيعية ثلاثية الحدود، ومعامل x² يساوي 1، أي أن a = 1. سنحلل الطرف الأيسر إلى عاملين.",
    display: "x² + 5x + 6 = 0",
    audio: "/audio/a1-step1.mp3",
  },
  {
    text: "نبحث عن رقمين m و n بحيث يكون حاصل ضربهما يساوي 6 (الحد الثابت c)، ومجموعهما يساوي 5 (معامل x وهو b).",
    display: "m × n = 6   و   m + n = 5",
    audio: "/audio/a1-step2.mp3",
  },
  {
    text: "نجرّب القيم الممكنة: العددان 2 و 3، حاصل ضربهما 6، ومجموعهما 5. هذان هما الرقمان المطلوبان.",
    display: "m = 2   ،   n = 3",
    audio: "/audio/a1-step3.mp3",
  },
  {
    text: "نكتب المعادلة على صورة حاصل ضرب عاملين باستخدام الرقمين اللذين وجدناهما.",
    display: "(x + 2)(x + 3) = 0",
    audio: "/audio/a1-step4.mp3",
  },
  {
    text: "حاصل ضرب عاملين يساوي صفر يعني أن أحدهما على الأقل يساوي صفر. نجعل كل عامل يساوي صفر على حدة.",
    display: "x + 2 = 0   أو   x + 3 = 0",
    audio: "/audio/a1-step5.mp3",
  },
  {
    text: "نحل كل معادلة بسيطة على حدة لنحصل على قيمتي x.",
    display: "x = −2   أو   x = −3",
    audio: "/audio/a1-step6.mp3",
  },
  {
    text: "وبهذا نكون قد حصلنا على جذري المعادلة. يمكننا التحقق بالتعويض في المعادلة الأصلية.",
    display: "الحل النهائي: x = −2 ، x = −3",
    audio: "/audio/a1-step7.mp3",
    isFinal: true,
  },
];

export default function Example_AEquals1({ onNext }) {
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        {/* ── Header ── */}
        <div style={styles.eyebrow}>مثال محلول · معامل x² يساوي 1</div>
        <h1 style={styles.h1}>حل المعادلة x² + 5x + 6 = 0</h1>

        {/* ── Original equation (always visible) ── */}
        <div style={styles.equationBox}>
          <span style={styles.equationText}>x² + 5x + 6 = 0</span>
        </div>
