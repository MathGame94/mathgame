...
const DivisionTool = ({ num1, num2 }) => {
  ...
  if (digits1[0] <= digits2[0]) {
    useEffect(() => {
      if (botValue5 && botValue6) {
        checkBot6_extra1();
      }
    }, [botValue5, botValue6]);
  } else {
    useEffect(() => {
      if (botValue6 && extraNum1) {
        checkBot6_extra1();
      }
    }, [botValue6, extraNum1]);
  }
  ...
  if (digits1[0] <= digits2[0]) {
    useEffect(() => {
      if (botValue7 && botValue8) {
        checkBot8_extra2();
      }
    }, [botValue7, botValue8]);
  } else {
    useEffect(() => {
      if (botValue8 && extraNum2) {
        checkBot8_extra2();
      }
    }, [botValue8, extraNum2]);
  }
  ...
  if (digits1[0] <= digits2[0]) {
    useEffect(() => {
      if (botValue10 && botValue9) {
        checkBot10_extra3();
      }
    }, [botValue10, botValue9]);
  } else {
    useEffect(() => {
      if (botValue10 && extraNum3) {
        checkBot10_extra3();
      }
    }, [botValue10, extraNum3]);
  }
