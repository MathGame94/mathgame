...
// ── 5 Questions: السرعة = المسافة ÷ الزمن ──
const QUESTIONS = [
  {
    id: 1,
    ...
    steps: [
      {
        instruction: "اكتب قانون السرعة",
        placeholder: "مثال: س = م ÷ ز",
        accepted: ["س=م÷ز", "س = م ÷ ز", "س=م/ز", "س = م / ز"],
        hint: "السرعة تساوي المسافة مقسومة على الزمن",
        display: "س = م ÷ ز",
      },
      {
        instruction: "عوّض قيمتي المسافة والزمن في القانون",
        placeholder: "مثال: س = 180 ÷ 3",
        accepted: ["س=180÷3", "س = 180 ÷ 3", "س=180/3", "س = 180 / 3"],
        hint: "المسافة 180 كم والزمن 3 ساعات، نعوضهما في القانون",
        display: "س = 180 ÷ 3",
      },
      {
        instruction: "احسب السرعة النهائية مع كتابة الوحدة",
        placeholder: "مثال: س = 60 كم/س",
        accepted: ["س=60كم/س", "س = 60 كم/س", "60كم/س", "60"],
        hint: "180 ÷ 3 = 60، فتكون السرعة 60 كم/س",
        display: "س = 60 كم/س",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        instruction: "عوّض قيمتي المسافة والزمن في القانون",
        placeholder: "مثال: س = 240 ÷ 4",
        accepted: ["س=240÷4", "س = 240 ÷ 4", "س=240/4", "س = 240 / 4"],
        hint: "المسافة 240 كم والزمن 4 ساعات، نعوضهما في القانون",
        display: "س = 240 ÷ 4",
      },
      {
        instruction: "احسب السرعة النهائية مع كتابة الوحدة",
        placeholder: "مثال: س = 60 كم/س",
        accepted: ["س=60كم/س", "س = 60 كم/س", "60كم/س", "60"],
        hint: "240 ÷ 4 = 60، فتكون السرعة 60 كم/س",
        display: "س = 60 كم/س",
      },
    ],
  },
  {
    id: 3,
    equation: "جسم قطع مسافة 300 كم في 5 ساعات، احسب سرعته",
    steps: [
      {
        instruction: "اكتب قانون السرعة",
        placeholder: "مثال: س = م ÷ ز",
      ...
      {
        instruction: "عوّض قيمتي المسافة والزمن في القانون",
        placeholder: "مثال: س = 300 ÷ 5",
        accepted: ["س=300÷5", "س = 300 ÷ 5", "س=300/5", "س = 300 / 5"],
        hint: "المسافة 300 كم والزمن 5 ساعات، نعوضهما في القانون",
        display: "س = 300 ÷ 5",
      },
      {
        instruction: "احسب السرعة النهائية مع كتابة الوحدة",
        placeholder: "مثال: س = 60 كم/س",
        accepted: ["س=60كم/س", "س = 60 كم/س", "60كم/س", "60"],
        hint: "300 ÷ 5 = 60، فتكون السرعة 60 كم/س",
        display: "س = 60 كم/س",
      },
    ],
  },
  {
    id: 4,
    equation: "جسم قطع مسافة 150 كم في 2 ساعة، احسب سرعته",
    steps: [
      {
        instruction: "اكتب قانون السرعة",
        placeholder: "مثال: س = م ÷ ز",
      ...
      {
        instruction: "عوّض قيمتي المسافة والزمن في القانون",
        placeholder: "مثال: س = 150 ÷ 2",
        accepted: ["س=150÷2", "س = 150 ÷ 2", "س=150/2", "س = 150 / 2"],
        hint: "المسافة 150 كم والزمن 2 ساعة، نعوضهما في القانون",
        display: "س = 150 ÷ 2",
      },
      {
        instruction: "احسب السرعة النهائية مع كتابة الوحدة",
        placeholder: "مثال: س = 75 كم/س",
        accepted: ["س=75كم/س", "س = 75 كم/س", "75كم/س", "75"],
        hint: "150 ÷ 2 = 75، فتكون السرعة 75 كم/س",
        display: "س = 75 كم/س",
      },
    ],
  },
  {
    id: 5,
    equation: "جسم قطع مسافة 420 كم في 6 ساعات، احسب سرعته",
    steps: [
      {
        instruction: "اكتب قانون السرعة",
        placeholder: "مثال: س = م ÷ ز",
      ...
      {
        instruction: "عوّض قيمتي المسافة والزمن في القانون",
        placeholder: "مثال: س = 420 ÷ 6",
        accepted: ["س=420÷6", "س = 420 ÷ 6", "س=420/6", "س = 420 / 6"],
        hint: "المسافة 420 كم والزمن 6 ساعات، نعوضهما في القانون",
        display: "س = 420 ÷ 6",
      },
      {
        instruction: "احسب السرعة النهائية مع كتابة الوحدة",
        placeholder: "مثال: س = 70 كم/س",
        accepted: ["س=70كم/س", "س = 70 كم/س", "70كم/س", "70"],
        hint: "420 ÷ 6 = 70، فتكون السرعة 70 كم/س",
        display: "س = 70 كم/س",
      },
    ],
  },
...
export default function Questions_Speed({ onFinish }) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · السرعة</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين السرعة · النتيجة</div>
