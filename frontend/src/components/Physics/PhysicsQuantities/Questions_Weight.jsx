...
// ── 5 Questions: الوزن = الكتلة × عجلة الجاذبية (ج = 10 م/ث²) ──
const QUESTIONS = [
  {
    id: 1,
    equation: "جسم كتلته 6 كجم، احسب وزنه (ج = 10 م/ث²)",
    steps: [
      {
        instruction: "اكتب قانون الوزن",
        placeholder: "مثال: و = ك × ج",
        accepted: ["و=ك×ج", "و = ك × ج", "و=كxج", "و = ك x ج"],
        hint: "الوزن يساوي الكتلة مضروبة في عجلة الجاذبية الأرضية",
        display: "و = ك × ج",
      },
      {
        instruction: "عوّض قيمتي الكتلة وعجلة الجاذبية في القانون",
        placeholder: "مثال: و = 6 × 10",
        accepted: ["و=6×10", "و = 6 × 10", "و=6x10", "و = 6 x 10"],
        hint: "الكتلة 6 كجم وعجلة الجاذبية 10 م/ث²، نعوضهما في القانون",
        display: "و = 6 × 10",
      },
      {
        instruction: "احسب الوزن النهائي مع كتابة الوحدة",
        placeholder: "مثال: و = 60 ن",
        accepted: ["و=60ن", "و = 60 ن", "60ن", "60"],
        hint: "6 × 10 = 60، فيكون الوزن 60 نيوتن (ن)",
        display: "و = 60 ن",
      },
    ],
  },
  {
    id: 2,
    equation: "جسم كتلته 9 كجم، احسب وزنه (ج = 10 م/ث²)",
    steps: [
      {
        instruction: "اكتب قانون الوزن",
        placeholder: "مثال: و = ك × ج",
      ...
      {
        instruction: "عوّض قيمتي الكتلة وعجلة الجاذبية في القانون",
        placeholder: "مثال: و = 9 × 10",
        accepted: ["و=9×10", "و = 9 × 10", "و=9x10", "و = 9 x 10"],
        hint: "الكتلة 9 كجم وعجلة الجاذبية 10 م/ث²، نعوضهما في القانون",
        display: "و = 9 × 10",
      },
      {
        instruction: "احسب الوزن النهائي مع كتابة الوحدة",
        placeholder: "مثال: و = 90 ن",
        accepted: ["و=90ن", "و = 90 ن", "90ن", "90"],
        hint: "9 × 10 = 90، فيكون الوزن 90 نيوتن (ن)",
        display: "و = 90 ن",
      },
    ],
  },
  {
    id: 3,
    equation: "جسم كتلته 12 كجم، احسب وزنه (ج = 10 م/ث²)",
    steps: [
      {
        instruction: "اكتب قانون الوزن",
        placeholder: "مثال: و = ك × ج",
      ...
      {
        instruction: "عوّض قيمتي الكتلة وعجلة الجاذبية في القانون",
        placeholder: "مثال: و = 12 × 10",
        accepted: ["و=12×10", "و = 12 × 10", "و=12x10", "و = 12 x 10"],
        hint: "الكتلة 12 كجم وعجلة الجاذبية 10 م/ث²، نعوضهما في القانون",
        display: "و = 12 × 10",
      },
      {
        instruction: "احسب الوزن النهائي مع كتابة الوحدة",
        placeholder: "مثال: و = 120 ن",
        accepted: ["و=120ن", "و = 120 ن", "120ن", "120"],
        hint: "12 × 10 = 120، فيكون الوزن 120 نيوتن (ن)",
        display: "و = 120 ن",
      },
    ],
  },
  {
    id: 4,
    equation: "جسم كتلته 7 كجم، احسب وزنه (ج = 10 م/ث²)",
    steps: [
      {
        instruction: "اكتب قانون الوزن",
        placeholder: "مثال: و = ك × ج",
      ...
      {
        instruction: "عوّض قيمتي الكتلة وعجلة الجاذبية في القانون",
        placeholder: "مثال: و = 7 × 10",
        accepted: ["و=7×10", "و = 7 × 10", "و=7x10", "و = 7 x 10"],
        hint: "الكتلة 7 كجم وعجلة الجاذبية 10 م/ث²، نعوضهما في القانون",
        display: "و = 7 × 10",
      },
      {
        instruction: "احسب الوزن النهائي مع كتابة الوحدة",
        placeholder: "مثال: و = 70 ن",
        accepted: ["و=70ن", "و = 70 ن", "70ن", "70"],
        hint: "7 × 10 = 70، فيكون الوزن 70 نيوتن (ن)",
        display: "و = 70 ن",
      },
    ],
  },
  {
    id: 5,
    equation: "جسم كتلته 25 كجم، احسب وزنه (ج = 10 م/ث²)",
    steps: [
      {
        instruction: "اكتب قانون الوزن",
        placeholder: "مثال: و = ك × ج",
      ...
      {
        instruction: "عوّض قيمتي الكتلة وعجلة الجاذبية في القانون",
        placeholder: "مثال: و = 25 × 10",
        accepted: ["و=25×10", "و = 25 × 10", "و=25x10", "و = 25 x 10"],
        hint: "الكتلة 25 كجم وعجلة الجاذبية 10 م/ث²، نعوضهما في القانون",
        display: "و = 25 × 10",
      },
      {
        instruction: "احسب الوزن النهائي مع كتابة الوحدة",
        placeholder: "مثال: و = 250 ن",
        accepted: ["و=250ن", "و = 250 ن", "250ن", "250"],
        hint: "25 × 10 = 250، فيكون الوزن 250 نيوتن (ن)",
        display: "و = 250 ن",
      },
    ],
  },
...
export default function Questions_Weight({ onFinish }) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · الوزن</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين الوزن · النتيجة</div>
