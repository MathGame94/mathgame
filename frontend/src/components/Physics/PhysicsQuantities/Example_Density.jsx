...
// ── Example 1: جسم كتلته 120 جم وحجمه 40 سم³ ──
const EXAMPLE_1 = {
  equation: "جسم كتلته 120 جم وحجمه 40 سم³، احسب كثافته",
  label: "كتلة وحجم معطيان",
  steps: [
    {
      text: "الكثافة تدل على مقدار الكتلة في وحدة الحجم. قانون الكثافة هو قسمة الكتلة على الحجم. هنا الكتلة 120 جم والحجم 40 سم³.",
      display: "كث = ك ÷ ح",
      audio: "/audio/density-example1-step1.mp3",
    },
    {
      text: "نعوّض القيم المعطاة في القانون: الكتلة 120 جم والحجم 40 سم³.",
      display: "كث = 120 ÷ 40",
      audio: "/audio/density-example1-step2.mp3",
    },
    {
      text: "نقسم الكتلة على الحجم: 120 ÷ 40 = 3.",
      display: "كث = 3",
      audio: "/audio/density-example1-step3.mp3",
    },
    {
      text: "وبهذا حصلنا على الكثافة. وحدة الكثافة هي جم/سم³ لأنها كتلة مقسومة على حجم.",
      display: "الحل النهائي: كث = 3 جم/سم³",
      audio: "/audio/density-example1-step4.mp3",
      isFinal: true,
    },
  ],
};

// ── Example 2: جسم كتلته 350 جم وحجمه 50 سم³ ──
const EXAMPLE_2 = {
  equation: "جسم كتلته 350 جم وحجمه 50 سم³، احسب كثافته",
  label: "تطبيق آخر",
  steps: [
    {
      text: "نستخدم نفس قانون الكثافة: الكثافة تساوي الكتلة مقسومةً على الحجم. هنا الكتلة 350 جم والحجم 50 سم³.",
      display: "كث = ك ÷ ح",
      audio: "/audio/density-example2-step1.mp3",
    },
    {
      text: "نعوّض القيم المعطاة في القانون: الكتلة 350 جم والحجم 50 سم³.",
      display: "كث = 350 ÷ 50",
      audio: "/audio/density-example2-step2.mp3",
    },
    {
      text: "نقسم الكتلة على الحجم: 350 ÷ 50 = 7.",
      display: "كث = 7",
      audio: "/audio/density-example2-step3.mp3",
    },
    {
      text: "وبهذا حصلنا على الكثافة مع كتابة وحدة جم/سم³.",
      display: "الحل النهائي: كث = 7 جم/سم³",
      audio: "/audio/density-example2-step4.mp3",
      isFinal: true,
    },
  ],
};
...
export default function Example_Density({ onNext }) {
  ...
  const sendToWhatsApp = () => {
    ...
    const msg =
      `📚 *سؤال من الطالب: ${name}*\n` +
      `📌 *المثال:* حساب الكثافة - ${example.equation}\n\n` +
      `❓ *السؤال:*\n${question.trim()}`;
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {/* ── Header ── */}
        <div style={styles.eyebrow}>مثال محلول · الكثافة</div>
        <h1 style={styles.h1}>حساب الكثافة · {example.equation}</h1>
        ...
        <div style={styles.formulaReminder}>
          ...
          <span style={styles.formulaText}>الكثافة = الكتلة ÷ الحجم &nbsp;|&nbsp; كث = ك ÷ ح</span>
        </div>
      ...
      <button onClick={() => { navigate("/questionsDensity"); }} style={styles.exerciseBtn}>
        ابدأ التمرين ←
      </button>
      <style>{`
        @keyframes pulse {
