...
// ── Example 1: جسم حجمه 30 سم³ وكثافته 4 جم/سم³ ──
const EXAMPLE_1 = {
  equation: "جسم حجمه 30 سم³ وكثافته 4 جم/سم³",
  label: "حجم معطى وكثافة",
  steps: [
    {
      text: "قانون الكتلة يربط بين ثلاث كميات: الكتلة والكثافة والحجم. الكتلة تساوي الكثافة مضروبةً في الحجم. هنا الكثافة 4 جم/سم³ والحجم 30 سم³.",
      display: "ك = كث × ح",
      audio: "/audio/mass-example1-step1.mp3",
    },
    {
      text: "نعوّض القيم المعطاة في القانون: الكثافة 4 جم/سم³ والحجم 30 سم³.",
      display: "ك = 4 × 30",
      audio: "/audio/mass-example1-step2.mp3",
    },
    {
      text: "نضرب العددين: 4 × 30 = 120.",
      display: "ك = 120",
      audio: "/audio/mass-example1-step3.mp3",
    },
    {
      text: "وبهذا حصلنا على الكتلة. لا ننسى كتابة وحدة الكتلة وهي الجرام.",
      display: "الحل النهائي: ك = 120 جم",
      audio: "/audio/mass-example1-step4.mp3",
      isFinal: true,
    },
  ],
};

// ── Example 2: جسم حجمه 25 سم³ وكثافته 6 جم/سم³ ──
const EXAMPLE_2 = {
  equation: "جسم حجمه 25 سم³ وكثافته 6 جم/سم³",
  label: "تطبيق آخر",
  steps: [
    {
      text: "نستخدم نفس قانون الكتلة: الكتلة تساوي الكثافة مضروبةً في الحجم. هنا الكثافة 6 جم/سم³ والحجم 25 سم³.",
      display: "ك = كث × ح",
      audio: "/audio/mass-example2-step1.mp3",
    },
    {
      text: "نعوّض القيم المعطاة في القانون: الكثافة 6 جم/سم³ والحجم 25 سم³.",
      display: "ك = 6 × 25",
      audio: "/audio/mass-example2-step2.mp3",
    },
    {
      text: "نضرب العددين: 6 × 25 = 150.",
      display: "ك = 150",
      audio: "/audio/mass-example2-step3.mp3",
    },
    {
      text: "وبهذا حصلنا على الكتلة مع كتابة وحدة الجرام.",
      display: "الحل النهائي: ك = 150 جم",
      audio: "/audio/mass-example2-step4.mp3",
      isFinal: true,
    },
  ],
};
...
export default function Example_Mass({ onNext }) {
  ...
  const sendToWhatsApp = () => {
    ...
    const msg =
      `📚 *سؤال من الطالب: ${name}*\n` +
      `📌 *المثال:* حساب الكتلة - ${example.equation}\n\n` +
      `❓ *السؤال:*\n${question.trim()}`;
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {/* ── Header ── */}
        <div style={styles.eyebrow}>مثال محلول · الكتلة</div>
        <h1 style={styles.h1}>حساب الكتلة · {example.equation}</h1>
        ...
        <div style={styles.formulaReminder}>
          ...
          <span style={styles.formulaText}>الكتلة = الكثافة × الحجم &nbsp;|&nbsp; ك = كث × ح</span>
        </div>
      ...
      <button onClick={() => { navigate("/questionsMass"); }} style={styles.exerciseBtn}>
        ابدأ التمرين ←
      </button>
      <style>{`
        @keyframes pulse {
