...
// ── 5 Questions: التسارع = (السرعة النهائية - السرعة الابتدائية) ÷ الزمن ──
const QUESTIONS = [
  {
    id: 1,
    ...
    steps: [
      {
        instruction: "اكتب قانون التسارع",
        placeholder: "مثال: ت = (سن - سب) ÷ ز",
        accepted: ["ت=(سن-سب)÷ز", "ت = (سن - سب) ÷ ز", "ت=(سن-سب)/ز", "ت = (سن - سب) / ز"],
        hint: "التسارع يساوي الفرق بين السرعة النهائية والسرعة الابتدائية مقسوماً على الزمن",
        display: "ت = (سن - سب) ÷ ز",
      },
      {
        instruction: "احسب الفرق بين السرعة النهائية والسرعة الابتدائية",
        placeholder: "مثال: سن - سب = 40 - 10 = 30",
        accepted: ["سن-سب=40-10=30", "سن - سب = 40 - 10 = 30", "40-10=30", "30"],
        hint: "السرعة النهائية 40 م/ث والسرعة الابتدائية 10 م/ث، نطرح: 40 - 10 = 30",
        display: "سن - سب = 40 - 10 = 30",
      },
      {
        instruction: "عوّض الفرق والزمن في القانون",
        placeholder: "مثال: ت = 30 ÷ 6",
        accepted: ["ت=30÷6", "ت = 30 ÷ 6", "ت=30/6", "ت = 30 / 6"],
        hint: "نقسم الفرق 30 على الزمن 6 ثوانٍ",
        display: "ت = 30 ÷ 6",
      },
      {
        instruction: "احسب التسارع النهائي مع كتابة الوحدة",
        placeholder: "مثال: ت = 5 م/ث²",
        accepted: ["ت=5م/ث²", "ت = 5 م/ث²", "ت=5م/ث2", "5م/ث²", "5"],
        hint: "30 ÷ 6 = 5، فيكون التسارع 5 م/ث²",
        display: "ت = 5 م/ث²",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        instruction: "احسب الفرق بين السرعة النهائية والسرعة الابتدائية",
        placeholder: "مثال: سن - سب = 35 - 5 = 30",
        accepted: ["سن-سب=35-5=30", "سن - سب = 35 - 5 = 30", "35-5=30", "30"],
        hint: "السرعة النهائية 35 م/ث والسرعة الابتدائية 5 م/ث، نطرح: 35 - 5 = 30",
        display: "سن - سب = 35 - 5 = 30",
      },
      {
        instruction: "عوّض الفرق والزمن في القانون",
        placeholder: "مثال: ت = 30 ÷ 5",
        accepted: ["ت=30÷5", "ت = 30 ÷ 5", "ت=30/5", "ت = 30 / 5"],
        hint: "نقسم الفرق 30 على الزمن 5 ثوانٍ",
        display: "ت = 30 ÷ 5",
      },
      {
        instruction: "احسب التسارع النهائي مع كتابة الوحدة",
        placeholder: "مثال: ت = 6 م/ث²",
        accepted: ["ت=6م/ث²", "ت = 6 م/ث²", "ت=6م/ث2", "6م/ث²", "6"],
        hint: "30 ÷ 5 = 6، فيكون التسارع 6 م/ث²",
        display: "ت = 6 م/ث²",
      },
    ],
  },
  {
    id: 3,
    equation: "جسم سرعته الابتدائية 8 م/ث وسرعته النهائية 48 م/ث خلال 8 ثوانٍ، احسب تسارعه",
    steps: [
      {
        instruction: "اكتب قانون التسارع",
        placeholder: "مثال: ت = (سن - سب) ÷ ز",
      ...
      {
        instruction: "احسب الفرق بين السرعة النهائية والسرعة الابتدائية",
        placeholder: "مثال: سن - سب = 48 - 8 = 40",
        accepted: ["سن-سب=48-8=40", "سن - سب = 48 - 8 = 40", "48-8=40", "40"],
        hint: "السرعة النهائية 48 م/ث والسرعة الابتدائية 8 م/ث، نطرح: 48 - 8 = 40",
        display: "سن - سب = 48 - 8 = 40",
      },
      {
        instruction: "عوّض الفرق والزمن في القانون",
        placeholder: "مثال: ت = 40 ÷ 8",
        accepted: ["ت=40÷8", "ت = 40 ÷ 8", "ت=40/8", "ت = 40 / 8"],
        hint: "نقسم الفرق 40 على الزمن 8 ثوانٍ",
        display: "ت = 40 ÷ 8",
      },
      {
        instruction: "احسب التسارع النهائي مع كتابة الوحدة",
        placeholder: "مثال: ت = 5 م/ث²",
        accepted: ["ت=5م/ث²", "ت = 5 م/ث²", "ت=5م/ث2", "5م/ث²", "5"],
        hint: "40 ÷ 8 = 5، فيكون التسارع 5 م/ث²",
        display: "ت = 5 م/ث²",
      },
    ],
  },
  {
    id: 4,
    equation: "جسم سرعته الابتدائية 12 م/ث وسرعته النهائية 32 م/ث خلال 4 ثوانٍ، احسب تسارعه",
    steps: [
      {
        instruction: "اكتب قانون التسارع",
        placeholder: "مثال: ت = (سن - سب) ÷ ز",
      ...
      {
        instruction: "احسب الفرق بين السرعة النهائية والسرعة الابتدائية",
        placeholder: "مثال: سن - سب = 32 - 12 = 20",
        accepted: ["سن-سب=32-12=20", "سن - سب = 32 - 12 = 20", "32-12=20", "20"],
        hint: "السرعة النهائية 32 م/ث والسرعة الابتدائية 12 م/ث، نطرح: 32 - 12 = 20",
        display: "سن - سب = 32 - 12 = 20",
      },
      {
        instruction: "عوّض الفرق والزمن في القانون",
        placeholder: "مثال: ت = 20 ÷ 4",
        accepted: ["ت=20÷4", "ت = 20 ÷ 4", "ت=20/4", "ت = 20 / 4"],
        hint: "نقسم الفرق 20 على الزمن 4 ثوانٍ",
        display: "ت = 20 ÷ 4",
      },
      {
        instruction: "احسب التسارع النهائي مع كتابة الوحدة",
        placeholder: "مثال: ت = 5 م/ث²",
        accepted: ["ت=5م/ث²", "ت = 5 م/ث²", "ت=5م/ث2", "5م/ث²", "5"],
        hint: "20 ÷ 4 = 5، فيكون التسارع 5 م/ث²",
        display: "ت = 5 م/ث²",
      },
    ],
  },
  {
    id: 5,
    equation: "جسم سرعته الابتدائية 6 م/ث وسرعته النهائية 54 م/ث خلال 8 ثوانٍ، احسب تسارعه",
    steps: [
      {
        instruction: "اكتب قانون التسارع",
        placeholder: "مثال: ت = (سن - سب) ÷ ز",
      ...
      {
        instruction: "احسب الفرق بين السرعة النهائية والسرعة الابتدائية",
        placeholder: "مثال: سن - سب = 54 - 6 = 48",
        accepted: ["سن-سب=54-6=48", "سن - سب = 54 - 6 = 48", "54-6=48", "48"],
        hint: "السرعة النهائية 54 م/ث والسرعة الابتدائية 6 م/ث، نطرح: 54 - 6 = 48",
        display: "سن - سب = 54 - 6 = 48",
      },
      {
        instruction: "عوّض الفرق والزمن في القانون",
        placeholder: "مثال: ت = 48 ÷ 8",
        accepted: ["ت=48÷8", "ت = 48 ÷ 8", "ت=48/8", "ت = 48 / 8"],
        hint: "نقسم الفرق 48 على الزمن 8 ثوانٍ",
        display: "ت = 48 ÷ 8",
      },
      {
        instruction: "احسب التسارع النهائي مع كتابة الوحدة",
        placeholder: "مثال: ت = 6 م/ث²",
        accepted: ["ت=6م/ث²", "ت = 6 م/ث²", "ت=6م/ث2", "6م/ث²", "6"],
        hint: "48 ÷ 8 = 6، فيكون التسارع 6 م/ث²",
        display: "ت = 6 م/ث²",
      },
    ],
  },
...
function isCorrect(input, accepted) {
  const clean = input.trim().replace(/\s+/g, "").replace(/−/g, "-").replace(/×/g, "*").replace(/÷/g, "/").replace(/x/gi, "*");
  return accepted.some((a) => {
    const cleanA = a.replace(/\s+/g, "").replace(/−/g, "-").replace(/×/g, "*").replace(/÷/g, "/").replace(/x/gi, "*");
    return clean === cleanA;
  });
}

export default function Questions_Acceleration({ onFinish }) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · التسارع</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين التسارع · النتيجة</div>
...
const styles = {
  ...
  equationText: { fontFamily: "'Segoe UI', Tahoma, sans-serif", direction: "rtl", fontSize: "clamp(13px, 3.2vw, 18px)", fontWeight: 700, color: "#FBF7F0" },
  ...
  completedFormula: { fontFamily: "Georgia, serif", direction: "ltr", fontSize: "clamp(12px, 2.8vw, 15px)", color: "#5B8266", fontWeight: 600 },
