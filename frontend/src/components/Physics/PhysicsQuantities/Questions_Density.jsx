...
// ── 5 Questions: الكثافة = الكتلة ÷ الحجم ──
const QUESTIONS = [
  {
    id: 1,
    equation: "جسم كتلته 120 جم وحجمه 40 سم³، احسب كثافته",
    steps: [
      {
        instruction: "اكتب قانون الكثافة",
        placeholder: "مثال: كث = ك ÷ ح",
        accepted: ["كث=ك÷ح", "كث = ك ÷ ح", "كث=ك/ح", "كث = ك / ح"],
        hint: "الكثافة تساوي الكتلة مقسومة على الحجم",
        display: "كث = ك ÷ ح",
      },
      {
        instruction: "عوّض قيمتي الكتلة والحجم في القانون",
        placeholder: "مثال: كث = 120 ÷ 40",
        accepted: ["كث=120÷40", "كث = 120 ÷ 40", "كث=120/40", "كث = 120 / 40"],
        hint: "الكتلة 120 جم والحجم 40 سم³، نعوضهما في القانون",
        display: "كث = 120 ÷ 40",
      },
      {
        instruction: "احسب الكثافة النهائية مع كتابة الوحدة",
        placeholder: "مثال: كث = 3 جم/سم³",
        accepted: ["كث=3جم/سم³", "كث = 3 جم/سم³", "كث=3جم/سم3", "3جم/سم³", "3"],
        hint: "120 ÷ 40 = 3، فتكون الكثافة 3 جم/سم³",
        display: "كث = 3 جم/سم³",
      },
    ],
  },
  {
    id: 2,
    equation: "جسم كتلته 350 جم وحجمه 50 سم³، احسب كثافته",
    steps: [
      {
        instruction: "اكتب قانون الكثافة",
        placeholder: "مثال: كث = ك ÷ ح",
      ...
      {
        instruction: "عوّض قيمتي الكتلة والحجم في القانون",
        placeholder: "مثال: كث = 350 ÷ 50",
        accepted: ["كث=350÷50", "كث = 350 ÷ 50", "كث=350/50", "كث = 350 / 50"],
        hint: "الكتلة 350 جم والحجم 50 سم³، نعوضهما في القانون",
        display: "كث = 350 ÷ 50",
      },
      {
        instruction: "احسب الكثافة النهائية مع كتابة الوحدة",
        placeholder: "مثال: كث = 7 جم/سم³",
        accepted: ["كث=7جم/سم³", "كث = 7 جم/سم³", "كث=7جم/سم3", "7جم/سم³", "7"],
        hint: "350 ÷ 50 = 7، فتكون الكثافة 7 جم/سم³",
        display: "كث = 7 جم/سم³",
      },
    ],
  },
  {
    id: 3,
    equation: "جسم كتلته 200 جم وحجمه 25 سم³، احسب كثافته",
    steps: [
      {
        instruction: "اكتب قانون الكثافة",
        placeholder: "مثال: كث = ك ÷ ح",
      ...
      {
        instruction: "عوّض قيمتي الكتلة والحجم في القانون",
        placeholder: "مثال: كث = 200 ÷ 25",
        accepted: ["كث=200÷25", "كث = 200 ÷ 25", "كث=200/25", "كث = 200 / 25"],
        hint: "الكتلة 200 جم والحجم 25 سم³، نعوضهما في القانون",
        display: "كث = 200 ÷ 25",
      },
      {
        instruction: "احسب الكثافة النهائية مع كتابة الوحدة",
        placeholder: "مثال: كث = 8 جم/سم³",
        accepted: ["كث=8جم/سم³", "كث = 8 جم/سم³", "كث=8جم/سم3", "8جم/سم³", "8"],
        hint: "200 ÷ 25 = 8، فتكون الكثافة 8 جم/سم³",
        display: "كث = 8 جم/سم³",
      },
    ],
  },
  {
    id: 4,
    equation: "جسم كتلته 90 جم وحجمه 15 سم³، احسب كثافته",
    steps: [
      {
        instruction: "اكتب قانون الكثافة",
        placeholder: "مثال: كث = ك ÷ ح",
      ...
      {
        instruction: "عوّض قيمتي الكتلة والحجم في القانون",
        placeholder: "مثال: كث = 90 ÷ 15",
        accepted: ["كث=90÷15", "كث = 90 ÷ 15", "كث=90/15", "كث = 90 / 15"],
        hint: "الكتلة 90 جم والحجم 15 سم³، نعوضهما في القانون",
        display: "كث = 90 ÷ 15",
      },
      {
        instruction: "احسب الكثافة النهائية مع كتابة الوحدة",
        placeholder: "مثال: كث = 6 جم/سم³",
        accepted: ["كث=6جم/سم³", "كث = 6 جم/سم³", "كث=6جم/سم3", "6جم/سم³", "6"],
        hint: "90 ÷ 15 = 6، فتكون الكثافة 6 جم/سم³",
        display: "كث = 6 جم/سم³",
      },
    ],
  },
  {
    id: 5,
    equation: "جسم كتلته 63 جم وحجمه 9 سم³، احسب كثافته",
    steps: [
      {
        instruction: "اكتب قانون الكثافة",
        placeholder: "مثال: كث = ك ÷ ح",
      ...
      {
        instruction: "عوّض قيمتي الكتلة والحجم في القانون",
        placeholder: "مثال: كث = 63 ÷ 9",
        accepted: ["كث=63÷9", "كث = 63 ÷ 9", "كث=63/9", "كث = 63 / 9"],
        hint: "الكتلة 63 جم والحجم 9 سم³، نعوضهما في القانون",
        display: "كث = 63 ÷ 9",
      },
      {
        instruction: "احسب الكثافة النهائية مع كتابة الوحدة",
        placeholder: "مثال: كث = 7 جم/سم³",
        accepted: ["كث=7جم/سم³", "كث = 7 جم/سم³", "كث=7جم/سم3", "7جم/سم³", "7"],
        hint: "63 ÷ 9 = 7، فتكون الكثافة 7 جم/سم³",
        display: "كث = 7 جم/سم³",
      },
    ],
  },
...
export default function Questions_Density({ onFinish }) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين · الكثافة</div>
  ...
  if (done) {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.eyebrow}>تمرين الكثافة · النتيجة</div>
