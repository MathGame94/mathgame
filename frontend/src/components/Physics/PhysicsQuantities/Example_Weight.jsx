...
// ── Example 1: جسم كتلته 8 كجم ──
const EXAMPLE_1 = {
  equation: "جسم كتلته 8 كجم، احسب وزنه (g = 10 م/ث²)",
  label: "كتلة معطاة",
  steps: [
    {
      text: "الوزن هو قوة جذب الأرض للجسم. قانون الوزن يربط بين الوزن والكتلة وعجلة الجاذبية الأرضية التي تساوي 10 م/ث². هنا كتلة الجسم 8 كجم.",
      display: "و = ك × ج",
      audio: "/audio/weight-example1-step1.mp3",
    },
    {
      text: "نعوّض القيم المعطاة في القانون: الكتلة 8 كجم وعجلة الجاذبية 10 م/ث².",
      display: "و = 8 × 10",
      audio: "/audio/weight-example1-step2.mp3",
    },
    {
      text: "نضرب العددين: 8 × 10 = 80.",
      display: "و = 80",
      audio: "/audio/weight-example1-step3.mp3",
    },
    {
      text: "وبهذا حصلنا على الوزن. وحدة الوزن هي النيوتن (ن) لأنه قوة وليس كتلة.",
      display: "الحل النهائي: و = 80 ن",
      audio: "/audio/weight-example1-step4.mp3",
      isFinal: true,
    },
  ],
};

// ── Example 2: جسم كتلته 15 كجم ──
const EXAMPLE_2 = {
  equation: "جسم كتلته 15 كجم، احسب وزنه (g = 10 م/ث²)",
  label: "تطبيق آخر",
  steps: [
    {
      text: "نستخدم نفس قانون الوزن: الوزن يساوي الكتلة مضروبةً في عجلة الجاذبية الأرضية 10 م/ث². هنا كتلة الجسم 15 كجم.",
      display: "و = ك × ج",
      audio: "/audio/weight-example2-step1.mp3",
    },
    {
      text: "نعوّض القيم المعطاة في القانون: الكتلة 15 كجم وعجلة الجاذبية 10 م/ث².",
      display: "و = 15 × 10",
      audio: "/audio/weight-example2-step2.mp3",
    },
    {
      text: "نضرب العددين: 15 × 10 = 150.",
      display: "و = 150",
      audio: "/audio/weight-example2-step3.mp3",
    },
    {
      text: "وبهذا حصلنا على الوزن مع كتابة وحدة النيوتن.",
      display: "الحل النهائي: و = 150 ن",
      audio: "/audio/weight-example2-step4.mp3",
      isFinal: true,
    },
  ],
};
...
export default function Example_Weight({ onNext }) {
  ...
  const sendToWhatsApp = () => {
    ...
    const msg =
      `📚 *سؤال من الطالب: ${name}*\n` +
      `📌 *المثال:* حساب الوزن - ${example.equation}\n\n` +
      `❓ *السؤال:*\n${question.trim()}`;
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {/* ── Header ── */}
        <div style={styles.eyebrow}>مثال محلول · الوزن</div>
        <h1 style={styles.h1}>حساب الوزن · {example.equation}</h1>
        ...
        <div style={styles.formulaReminder}>
          ...
          <span style={styles.formulaText}>الوزن = الكتلة × عجلة الجاذبية &nbsp;|&nbsp; و = ك × ج &nbsp;|&nbsp; ج = 10 م/ث²</span>
        </div>
      ...
      <button onClick={() => { navigate("/questionsWeight"); }} style={styles.exerciseBtn}>
        ابدأ التمرين ←
      </button>
      <style>{`
        @keyframes pulse {
